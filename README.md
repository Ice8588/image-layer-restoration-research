...
圖中的 Positive 限於合成資料自動指標；Attention 的多個標籤分別對應不同分支。其他探索與未採用設定見 [6–9 月研究時間軸與完整分支](docs/experiments/00_research_timeline.md)。
...
- [企業合作資料整體結果](docs/industry_aggregate_results.md)：QA、推論步數與生成設定比較。
