...
| 實驗執行 | 建立實驗矩陣，執行生成、重試與結果整理，保留停止與未完成工作 |
...
第三方模型、論文方法與原始美術素材依來源標註，不列為個人原創。本 repository 的 [精選實作](selected_implementation.md)為通用 mask 與 evaluation 工具；來源及重用條件見 [NOTICE](../NOTICE.md)。
