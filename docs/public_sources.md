...
官方 README 與 [LICENSE](https://github.com/QwenLM/Qwen-Image-Layered/blob/54c4fe47e76d745775e03fc66ee38457280ed9ea/LICENSE) 標示 Apache-2.0。這提供 repository 層級的授權依據，但本次未找到逐張底層 artwork 的來源聲明；依本作品集要求，暫以原站連結呈現，不另散布 PNG、衍生 masks 或結果。此為公開素材的權利確認待辦，不是企業機密分類。
...
Synthetic 圖像使用研究者已確認權利的自行生成素材；Qwen 與 Live2D 的來源研究保留，媒體再散布範圍待個別條件確認。未因來源是 public 而誤標成企業私有資料，也未因資料仍待確認就刪掉研究歷程。
